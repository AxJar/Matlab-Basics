...
% Last Modified by GUIDE v2.5 15-Apr-2021 08:26:01
...
texto1 = get(handles.edit1,'String');
texto2 = get(handles.edit2,'String');
int1 = str2num(texto1);
int2 = str2num(texto2);
resultado = (int1 + int2);
...
% --- Executes on button press in botonClear.
function botonClear_Callback(hObject, eventdata, handles)
set(handles.edit1,'String','');
set(handles.edit2,'String','');
set(handles.text4,'String','');
% hObject    handle to botonClear (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on button press in botonMultiplica.
function botonMultiplica_Callback(hObject, eventdata, handles)
texto1 = get(handles.edit1,'String');
texto2 = get(handles.edit2,'String');
int1 = str2num(texto1);
int2 = str2num(texto2);
...
resultado = num2str(resultado);
set(handles.text4,'String',resultado);
% hObject    handle to botonMultiplica (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
