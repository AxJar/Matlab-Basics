...
% Last Modified by GUIDE v2.5 15-Apr-2021 08:46:01
...
set(hObject,'SliderStep',[1/100,0.1]);
% hObject    handle to slider1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
texto1 = get(hObject,'String');
n1 = set(handles.slider1,'Value',str2num(texto1));
...
valor = get(hObject,'Value');
set(handles.edit2,'String',num2str(valor));
...
texto2 = get(hObject,'String');
n2 = set(handles.slider3,'Value',str2num(texto2));
...
valor1 = get(handles.slider1,'Value');
